import { CheckBox, DesignServices, Person, Send, Upload } from '@mui/icons-material';
...
const SignupServiceProvider = () => {
  ...
  return (
    <Stack sx={{width:'50%',my:"200px",mx:'auto'}}>
        <Stack>
          <Typography variant='h5' color='primary' textAlign='center' mb='50px'>Register as a Service Provider</Typography>
        </Stack>
        <form>
          <Stack rowGap={3} >
            <Stack direction='column-reverse' alignItems='center'>
              ...
              {(personHovered) ? (
                ...
                <DesignServices sx={{ width: 96, height: 96 }} />
              )}
              </Avatar>
              <Typography variant='body1'  >please choose your picture</Typography>
            </Stack>
            ...
            <Stack >
              <TextField label='please input adescription for your Service can you provided' rows={4} multiline required size='small'  sx={{width:'100%','&:hover':{outline:"none",border:'none'}}}/>
            </Stack>
            ...
            <Stack direction='row' justifyContent='space-between' alignItems="center">
                ...
                <Link sx={{cursor:'pointer'}}>Register as a User</Link>
            </Stack>
